...
// Function to generate HTML content - LOCKED VERSION FOR RUSHING LEADERS
        ...
        <div class="p-8 h-full flex flex-col">
            ...
            <div class="flex-1 flex flex-col justify-center space-y-3">
                ${data.teams.map(team => {
                  ...
                  // LOCKED FORMAT FOR RUSHING YARDS - DO NOT MODIFY
                  if (data.type === 'rushingYards') {
...
async function main() {
  try {
    console.log('🎨 Generating CFB Leaders graphic (LOCKED VERSION)...');
    ...
    const htmlOutputPath = path.join(__dirname, '..', 'output', 'leaders-LOCKED.html');
    ...
    const pngOutputPath = path.join(__dirname, '..', 'output', 'leaders-LOCKED.png');
...
if (import.meta.url === `file://${process.argv[1]}`) {
  console.log('🚀 Starting Leaders generation script (LOCKED VERSION)...');
  main().catch(error => {
